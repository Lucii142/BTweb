...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, e, q) {
        ...
        if ("function" == typeof m) {
            b = m.call(b);
            for (var r = 0; !(m = b.next()).done;) h.push(e.call(q, m.value, r++))
        } else
...
$jscomp.checkStringArgs = function(b, h, e) {
    if (null == b) throw new TypeError("The 'this' value for String.prototype." + e + " must not be null or undefined");
    if (h instanceof RegExp) throw new TypeError("First argument to String.prototype." + e + " must not be a regular expression");
    return b + ""
};
...
(function() {
    ...
    function r(a) {
        ...
        (function d() {
            ...
            1 < (g += .1) || (a.style.opacity = g, requestAnimationFrame(d))
        })()
    }
    ...
    function H(a) {
        ...
        a.querySelectorAll(".carousel-item").forEach(function(a) {
            for (var c = a, b = 1; b < d; b++) {
                ...
                if (g = c) {
                    var e = 0;
                    do e++; while (g = g.previousElementSibling);
                    g = e
                } else g = -1;
    ...
    function I(a) {
        ...
        if (d) {
            ...
            for (var b = 0; b < d.length; b++) c.push('"' + d[b].getAttribute("stop-color") + '"');
            c = '"lineargradient": [' + c + "],";
    ...
    function z(a, c, d) {
        ...
        k.contains("row") &&
            (k.remove("row"), k.add("media-container-row"));
    ...
    Element.prototype.parents = function(a) {
        for (var c = [], b = this, g = void 0 !== a; null !== (b = b.parentElement);) b.nodeType === Node.ELEMENT_NODE && (g && !b.matches(a) || c.push(b));
        return c
    };
    Element.prototype.footerReveal = function() {
        function a() {
            !g && c.offsetHeight <= window.outerHeight ? (c.style.zIndex = "-999", c.style.position = "fixed", c.style.bottom = "0", c.style.width = b.offsetWidth + "px", b.style.marginBottom = c.offsetHeight + "px") : (c.style.zIndex = "", c.style.position =
    ...
    l(function() {
            ...
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (c) {
                    ...
                    if (k && (/youtu\.?be/g.test(k[3]) || /vimeo/g.test(k[3])))
                                ...
                                if (120 === (t.naturalWidth || t.width)) {
                                    ...
                                    switch (b) {
                                        ...
                                        case "sddefault.jpg":
                                            ...
                                            break;
                                        default:
                                            n && (g.style.backgroundImage = 'url("images/no-video.jpg")', g.style.display = "block")
                                    }
                                } else g.style.backgroundImage = 'url("' + t.src + '")', g.style.display = "block";
                        ...
                        } else k && /vimeo/g.test(k[3]) && (b = new XMLHttpRequest,
                            b.open("GET", "https://vimeo.com/api/v2/video/" + k[6] + ".json", !0), b.onreadystatechange = function() {
                                if (4 === this.readyState)
                                    if (200 <= this.status && 400 > this.status) {
                                        var a = JSON.parse(this.responseText);
                                        g.style.backgroundImage = 'url("' + a[0].thumbnail_large + '")';
                                        g.style.display = "block"
                                    } else n && (g.style.backgroundImage = 'url("images/no-video.jpg")', g.style.display = "block")
                    ...
                    else if (n) g.style.backgroundImage = 'url("images/video-placeholder.jpg")', g.style.display =
                        "block";
                    else if (!n) {
        ...
        if (u) f(document).on("add.cards changeParameter.cards", function(c) {
            ...
            if (n) {
                ...
                f(document).on("changeParameter.cards", function(a, b, d, k) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", f(a.target).find(".mbr-background-video-preview").remove(),
                        f(a.target).find(".mbr-background-video").remove(), k) {
                        case "type":
        ...
        window.addEventListener("scroll", function() {
            ...
            if (p) {
                ...
                b ? c != p.fixed && (m ? (p.fixed = c, p.elm.classList.toggle("is-fixed")) : k = setTimeout(function() {
                    p.fixed = c;
                    p.elm.classList.toggle("is-fixed")
                }, 40)) : (p.fixed = !1, p.elm.classList.remove("is-fixed"))
            }
        });
        if (u) f(document).on("add.cards delete.cards", function(a) {
            g && clearTimeout(g);
        ...
        if (u) f(document).on("add.cards", function(a) {
        ...
        if (n) {
            ...
            f(document).on("add.cards", function(a) {
                !r.some(function(b) {
                    return b ===
                        a.target
                }) && a.target.hasAttribute("mbr-data-bg-video") && (r.push(a.target), d(a.target))
            })
        } else d(document.body);
        if (n) f(document).on("changeParameter.cards", function(a, b, c, k) {
            if ("bg" === b) switch (k) {
                case "type":
    ...
    if (!n) {
        if (u && f.fn.socialLikes) f(document).on("add.cards", function(a) {
        ...
        l(function() {
            if (!x() && document.querySelectorAll("input[name=animation]").length) {
                var a = function() {
                        ...
                        g.forEach(function(k) {
                            var g = k.offsetHeight,
                                e = d(k);
                            (e + g >= a && e - 50 <= c || b(k)) && k.classList.contains("hidden") && (k.classList.remove("hidden"), k.classList.add("animate__fadeInUp"), k.classList.add("animate__delay-1s"), k.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
                                function() {
                                    k.classList.remove("animate__animated animate__delay-1s animate__fadeInUp")
                                }, {
                                    once: !0
                                }))
                        })
                ...
                var g = Array.from(document.querySelectorAll("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info"));
    ...
    document.querySelectorAll("nav.navbar").length && (v = e(document.querySelector("nav.navbar")), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = v + "px"));
            ...
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    l.addEventListener("click", function(b) {
                        "VIDEO" !== b.target.tagName && (d ? (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== d.indexOf("vimeo") && e.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), l.style.display = "none", l.removeEventListener("click", a), h.style.zIndex = "0")
                    })
                };
    ...
    if (!n) {
        ...
        !x() && (v = document.querySelector("section.menu")) && (A = window.innerWidth, !v.querySelector(".navbar").classList.contains("collapsed") && 991 < A && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
    ...
    if (n && u) f(document).on("add.cards", function(a) {
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/builder/ai-website-maker.html">Best AI Website Maker</a> Mobirise v5.9.18 <a href="https://mobirise.com/builder/mac-website-builder.html">Mac Website Builder</a>';
